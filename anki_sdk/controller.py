...
# -------------------------------------------------------------------------------------
    ...
    def changeOffsetRight(self, speed:int, accel:int, offset:float):
        self.changeLane(speed, accel, offset)
        
    def changeOffsetLeft(self, speed:int, accel:int, offset:float):
        self.changeLane(speed, accel, offset * -1) 
    ...
    #         "magenta": 0x07
    #     }
    #     command = struct.pack("<Bf", colors.get(color), 0xff)
    #     self.carClass.sendCommand(command)
